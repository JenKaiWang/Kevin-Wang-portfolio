      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full relative z-10">
        <div className="flex flex-col-reverse lg:flex-row items-center justify-between gap-12">
          ...
          >
            ...
            >
              Passionate Computer Science master’s graduate focused on game development, interactive storytelling, and building immersive projects that bring game worlds to life.
            </motion.p>
